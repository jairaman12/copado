({
    doInit : function(component, event, helper) {
        //Get case recordid
        var b = component.get('c.validateContractingCaseOwner');
        $A.enqueueAction(b); 
    },
    validateContractingCaseOwner:function(component, event) {
        
        var caseId			=	component.get('v.recordId') ;
        var isButton 		= 	component.get('v.isLightningButton'); //Shows whether this was launched from the lightning button
        var sucessString 	=	'';	
        var action 			=	component.get('c.getContractingCaseOwnerUpdate');
